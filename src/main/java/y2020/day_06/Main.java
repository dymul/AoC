...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (String s : input) {
            if (!s.equals("")) {
                ...
                int count = count2(answers);
                System.out.println("Group: " + answers + ", count: " + count );
                sum += count;
                answers.clear();
            }
        }
    ...
    private static int count(List<String> answers) {
        Set<String> letters = new HashSet<>();
        for (String s : answers) {
            String[] splitted = s.split("");
            letters.addAll(Arrays.asList(splitted));
        }
        return letters.size();
    }

    private static int count2(List<String> answers) {
        Set<String> letters = new HashSet<>(Arrays.asList(answers.get(0).split("")));
        for (String s : answers) {
            letters.retainAll(Arrays.asList(s.split("")));
        }
        return letters.size();
    }
